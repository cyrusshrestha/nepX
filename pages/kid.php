...
$filter = "category = 'kids' AND quantity > 0 AND price BETWEEN $min_price AND $max_price";
...
<head>
  ...
  <title>🧒 Kid Shoes | Nepal StockX</title>
  ...
  <div class="box">
    ...
    Brand: <strong><?= htmlspecialchars($row['brand']) ?></strong>
      ...
      <div class="products_text">
        ...
        <?php if (!is_null($row['last_sale_price']) && $row['last_sale_price'] > 0 && $row['last_sale_price'] != $row['price']): ?>
